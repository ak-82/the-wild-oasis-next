...
function DeleteReservation({bookingId, onDelete}) {
  ...
  return (
    <button onClick={handleDeleteReservation}
            className='group flex items-center gap-2 uppercase text-xs font-bold text-primary-300 flex-grow px-3 hover:bg-red-500 transition-colors hover:text-primary-900'>
